...
<template>
  <div>
    <OrganismDialogAbout />
    <OrganismDialogEditProfile />
    <Menubar class="rounded-none border-b border-none px-2 lg:px-4">
      <MenubarMenu>
        <MenubarTrigger class="font-bold"> inpiniti/book </MenubarTrigger>
        <MenubarContent>
          <MenubarItem @click="aboutClick"> About inpiniti/book </MenubarItem>
          <MenubarSeparator />
          <MenubarItem @click="preferencesClick"> Preferences... </MenubarItem>
          <MenubarSeparator />
          <MenubarShortcut />
          <MenubarItem> Quit inpiniti/book </MenubarItem>
        </MenubarContent>
      </MenubarMenu>
      <MenubarMenu>
